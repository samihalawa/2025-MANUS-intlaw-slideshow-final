...
const FormInput = ({ label, value, onChange }: { label: string; value: string; onChange: (e: React.ChangeEvent<HTMLInputElement>) => void; }) => (
    <div className="mb-4">
        ...
        <input type="text" value={value} onChange={onChange} className="w-full bg-white border-2 border-slate-300 rounded-md p-3 text-2xl text-slate-800 outline-none focus:ring-1 focus:ring-cyan-500 transition-all"/>
    </div>
);
        ...
        <SlideWrapper className="p-8 flex flex-col">
            ...
            <div className="flex-grow bg-slate-50 rounded-xl border border-slate-200 flex min-h-[550px]">
                ...
                <div className="w-2/5 border-r border-slate-200 p-6 flex flex-col bg-white rounded-l-xl">
                    <h3 className="font-bold text-slate-900 text-3xl mb-2">Nuevo Documento</h3>
                    ...
                    <div className="flex-grow">
                     ...
                     <button 
                        ...
                        className="w-full bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold py-3 rounded-lg transition-colors text-xl flex items-center justify-center gap-3 mb-3">
