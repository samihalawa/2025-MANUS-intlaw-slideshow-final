...
const ChatbotMockup = () => (
  <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden">
    ...
    <div className="p-6 space-y-4 h-96 bg-white/50">
      <div className="flex">
        <div className="p-4 rounded-2xl bg-slate-200 max-w-[80%] rounded-bl-none">
          <p className="text-2xl text-slate-800">¡Hola! ¿En qué puedo ayudarte?</p>
        </div>
      </div>
      <div className="flex justify-end">
        <div className="p-4 rounded-2xl bg-cyan-600 text-white max-w-[80%] rounded-br-none">
          <p className="text-2xl">Necesito un contrato mercantil.</p>
        </div>
      </div>
       <div className="flex">
        <div className="p-4 rounded-2xl bg-slate-200 max-w-[80%] rounded-bl-none">
          <p className="text-2xl text-slate-800">Perfecto. ¿Tu email?</p>
        </div>
      </div>
    </div>
    <div className="p-4 border-t border-slate-200 bg-slate-100/80">
        <input type="text" placeholder="Escribe tu mensaje..." className="w-full bg-white border-2 border-slate-300 rounded-lg p-4 text-xl text-slate-700 placeholder-slate-400 focus:ring-cyan-500 focus:border-cyan-500 outline-none transition-all" />
    </div>
  </div>
);
