...
const Node = ({ name, position, isCentral = false }: { name: string, position: string, isCentral?: boolean }) => (
    <motion.div
        className={`absolute ${position} w-40 h-40 rounded-full flex items-center justify-center text-center p-2 text-xl font-semibold border-4 ${isCentral ? 'bg-cyan-500 text-white border-cyan-700' : 'bg-white text-slate-800 border-slate-300'} shadow-lg`}
...
export const Slide10_C: React.FC = () => {
    ...
    return (
        <SlideWrapper className="p-12 flex flex-col">
            <h2 className="text-7xl font-bold tracking-tighter text-slate-900 text-center mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>Inteligencia Documental</h2>
            <p className="text-3xl text-slate-600 mb-8 text-center">Conectando datos clave.</p>
            <div className="flex-grow grid grid-cols-3 gap-8">
                ...
                <div className="col-span-2 bg-slate-50/70 rounded-2xl p-6 border border-slate-200 relative">
                     <h3 className="text-3xl font-bold text-slate-800 mb-4 flex items-center gap-3"><Link className="text-cyan-500"/> Mapa de Entidades</h3>
                ...
                <div className="flex flex-col gap-8">
                    <div className="bg-slate-50/70 rounded-2xl p-6 border border-slate-200 flex-1">
                        <h3 className="text-3xl font-bold text-slate-800 mb-4 flex items-center gap-3"><AlertTriangle className="text-red-500"/> Cláusulas Clave</h3>
                        <div className="space-y-3">
                            <div className="bg-red-500/10 p-3 rounded-md border-l-4 border-red-500">
                                <p className="font-semibold text-slate-800 text-3xl">Contradicción P.I.</p>
                                <p className="text-slate-600 text-2xl">Contrato Principal vs. Anexo II</p>
                            </div>
                             <div className="bg-yellow-500/10 p-3 rounded-md border-l-4 border-yellow-500">
                                <p className="font-semibold text-slate-800 text-3xl">Vencimiento</p>
                                <p className="text-slate-600 text-2xl">Acuerdo de Confidencialidad</p>
                            </div>
                        </div>
                    </div>
                     <div className="bg-slate-50/70 rounded-2xl p-6 border border-slate-200 flex-1">
                        <h3 className="text-3xl font-bold text-slate-800 mb-4 flex items-center gap-3"><CalendarDays className="text-cyan-500"/> Línea de Tiempo</h3>
