...
const dashboardVariants: Variants = {
    hidden: { },
    visible: { transition: { staggerChildren: 0.4, delay: 6.0 } }
};
...
export const Slide08_B: React.FC = () => {
    return (
        <SlideWrapper className="p-16">
            <h2 className="text-7xl font-bold tracking-tighter text-slate-900 mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>Módulo 1: Captación Multicanal y Cualificación IA</h2>
