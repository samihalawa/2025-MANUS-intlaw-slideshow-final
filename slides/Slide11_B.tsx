    ...
    return (
        <SlideWrapper className="p-12 flex flex-col">
            <div className="text-center mb-6">
                <h2 className="text-6xl font-bold tracking-tighter text-slate-900" style={{ fontFamily: "'Playfair Display', serif" }}>Análisis de Documentos con Citas</h2>
                <p className="text-2xl text-slate-600 mt-2">IA analiza y cita sus fuentes.</p>
            ...
            <div className="flex-grow bg-slate-50 rounded-2xl border border-slate-200 flex shadow-xl">
                ...
                <div className="w-3/5 border-r border-slate-200 p-8">
                    ...
                    <div className="mt-4 bg-white rounded-lg p-6 h-[400px] shadow-inner border border-slate-200 overflow-hidden">
                        <div className="font-mono text-slate-800 text-2xl leading-relaxed space-y-4">
                            <p><strong>Artículo 4. Transferencia de Activos.</strong></p>
                            <p><strong>4.A.</strong> La Vendedora transferirá todos los activos materiales del Anexo I.</p>
                            <p className="relative">
                                ...
                                <span className="relative"><strong>4.B.</strong> La Compradora adquirirá todos los derechos de Propiedad Intelectual.</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-2/5 p-8 flex flex-col">
                     ...
                     <div className="flex-grow space-y-4">
                        ...
                        <div className="flex justify-end">
                            <div className="bg-[#1a2947] text-white p-3 rounded-2xl rounded-br-sm max-w-xs text-xl">
                                ¿Qué dice sobre P.I.?
                            </div>
                        </div>
                        {/* AI Message */}
                        <div className="flex justify-start">
                            <motion.div 
                                className="bg-white border border-slate-200 p-3 rounded-2xl rounded-bl-sm max-w-sm text-xl shadow-md"
                                initial={{ opacity: 0, y: 10 }}
                                animate={{ opacity: 1, y: 0, transition: { delay: 1 } }}
                            >
                                <p className="text-slate-800">Transfiere toda la P.I. a la Compradora.</p>
                                <motion.div 
                     ...
                     <input type="text" placeholder="Pregunta algo sobre los documentos..." className="w-full bg-white border-2 border-slate-300 rounded-lg p-3 text-lg mt-4" disabled />
                </div>
            </div>
        </SlideWrapper>
    );
